...
mod tests {
    ...
    fn test_font_color_serialization() {
        ...
        // Deserialize back
        let deserialized: FontColor = serde_json::from_str(&serialized).expect("Failed to deserialize FontColor");
    ...
    fn test_text_style_serialization() {
        ...
        // Deserialize back
        let deserialized: TextStyle = serde_json::from_str(&serialized).expect("Failed to deserialize TextStyle");
        ...
        assert_eq!(original_style.horizontal_alignment, deserialized.horizontal_alignment);
        assert_eq!(original_style.vertical_alignment, deserialized.vertical_alignment);
